					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								<strong>员工列表</strong><span class="tools pull-right"> <a
										...
										<tbody>
											<c:forEach items="${employeeList}" var="item">
												...
												<td>${item.jobid}</td>
													...
													</a> <a href="${basePath}/employee/delete?id=${item.id}" style="padding-left: 10px">
				...
				<div class="modal-content">
					...
					<div class="modal-body row">
						...
						<div class="form-group">
								<label> 工号：</label> <input id="jobid" name="jobid"
									class="form-control">
							</div>
							<div class="form-group">
