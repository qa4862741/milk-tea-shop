...
<body>
					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								<strong>角色列表</strong><span class="tools pull-right"> <a
				...
				<div class="modal-content">
					...
					<div class="modal-body row">
						<div class="col-md-5">
							...
							<div class="form-group">
								<label> 状态：</label> <input id="state" name="state"
									class="form-control">
							</div>
							<div class="form-group">
	...
	<script src="<c:url value="/resources/js/lyGrid.js"/>"
	...
	<script type="text/javascript">
		...
		grid = lyGrid({
			...
			jsonUrl : basePath + '/resources/treeList',
			checkbox : true,
			usePage : false,
			records : "treeLists",
			treeGrid : {
